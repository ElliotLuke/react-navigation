...
<View style={styles.energy}>
        <Button style={styles.energyButton} onPress={() => this.navigate('Elec')} title="Electricity" color="#008000" accessibilityLabel="Choose electricity consumption"/>
        <Button style={styles.energyButton} onPress={() => this.navigate('Gas')} title="Gas" color="#008000" accessibilityLabel="choose gas consumption"/>
</View>
        <Button style={styles.button} onPress={() => this.props.navigator.pop()} title="Log Out" color="#008000" accessibilityLabel="Logout of account "/>
      </View>
    );
  }
}
